...
const RelatedTagsParser_js_1 = __importDefault(require("./RelatedTagsParser.js"));
class TagAPI extends BaseAPIWithImageSupport_js_1.default {
    async getRelated(params) {
        ...
        const json = await this.fetch(Constants_js_1.URLS.RELATED_TAGS, true, Fetcher_js_1.FetchMethod.POST, payload);
        return RelatedTagsParser_js_1.default.parseRelatedTags(json);
    }
}
