...
const ObjectHelper_js_1 = __importDefault(require("../utils/ObjectHelper.js"));
class FanInfoParser {
    ...
    static parseLoggedInFanUsername(html) {
        const $ = (0, cheerio_1.load)(html);
        const blob = (0, html_entities_1.decode)($('#HomepageApp[data-blob]').attr('data-blob'));
        let parsed;
        try {
            parsed = JSON.parse(blob);
        }
        ...
        const username = ObjectHelper_js_1.default.getProperty(parsed, 'pageContext.identity.fanUsername');
        if (!username || typeof username !== 'string') {
            ...
            throw new Parse_js_1.ParseError(`Failed to parse logged-in fan username: ${reason}.`, parsed);
        }
        return username;
    }
}
