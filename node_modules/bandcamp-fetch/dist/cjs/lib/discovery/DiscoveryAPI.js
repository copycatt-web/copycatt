...
class DiscoveryAPI extends BaseAPIWithImageSupport_js_1.default {
    ...
    async getRecommendedTagsAndLocations() {
        const html = await this.fetch(Constants_js_1.URLS.SITE_URL);
        return DiscoverOptionsParser_js_1.default.parseRecommendedTagsAndLocations(html);
    }
}
...
class LimiterDiscoveryAPI extends DiscoveryAPI {
    ...
    async getRecommendedTagsAndLocations() {
        return __classPrivateFieldGet(this, _LimiterDiscoveryAPI_limiter, "f").schedule(() => super.getRecommendedTagsAndLocations());
    }
}
